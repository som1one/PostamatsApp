...
// Цифры синхронизированы с моделью калькулятора (FranchiseCalculator.tsx):
// стартовая конфигурация — 2 постамата (~1,33 млн ₽), паушальный взнос
// 250 000 ₽, роялти 20% от оборота, прибыль с точки 55 000–80 000 ₽/мес
// по базовому сценарию, средний чек ~1490 ₽.
const metrics = [
  {
    value: "от 1,3 млн ₽",
    label: "инвестиции на старте",
    note: "* сеть из 2 постаматов, паушальный взнос 250 000 ₽, возможен лизинг",
  },
  { value: "1,3–1,9 млн ₽", label: "прибыль в год с сети из 2 постаматов" },
  { value: "0 ₽", label: "затраты на персонал" },
  {
    value: "55 000–80 000 ₽",
    label: "прибыль в месяц с одного постамата",
    note: "* базовый сценарий, зависит от города",
  },
  { value: "9–13 месяцев", label: "окупаемость" },
...
const franchiseFaq = [
  ...
  {
    category: "Франшиза",
    question: "Какие платежи, кроме инвестиций?",
    answer:
      "Паушальный взнос — 250 000 ₽ и роялти 20% от оборота. Взамен вы получаете IT-платформу, верификацию и поддержку клиентов, маркетинговые материалы и сопровождение запуска.",
  },
  {
    category: "Франшиза",
    question: "Как быстро окупается сеть?",
    answer:
      "Ориентир базового сценария — около 12 месяцев. В крупных городах и при активном сценарии — быстрее. Прозрачную финансовую модель с расчётом под ваш город пришлём после заявки.",
  },
  {
    category: "Франшиза",
  ...
  },
  {
    ...
    answer:
      "Стартовая конфигурация — сеть из 2 постаматов (от 1,3 млн ₽ инвестиций): несколько точек поддерживают друг друга по ассортименту и логистике. Дальше сеть масштабируется под спрос города.",
  },
  {
    category: "Франшиза",
      ...
      <section className="section-band franchise-economics">
        ...
        <div className="benefit-grid">
          <article className="benefit-card">
            ...
            <strong>Понятный вход</strong>
            <p>Старт — от 1,3 млн ₽ за сеть из 2 постаматов, возможен лизинг оборудования от партнёра.</p>
          </article>
          <article className="benefit-card">
            <span className="icon-badge">
              <TrendingUp size={20} />
