...
const metrics = [
  { value: "от 2 млн ₽", label: "инвестиции на старте", note: "* сеть из 3 постаматов, возможен лизинг" },
...
const franchiseFaq = [
  ...
  },
  {
    ...
    answer:
      "Стартовая конфигурация — сеть из 3 постаматов (2 млн ₽ инвестиций): несколько точек поддерживают друг друга по ассортименту и логистике. Дальше сеть масштабируется под спрос города.",
  },
  {
    category: "Франшиза",
      ...
      <section className="section-band franchise-economics">
        ...
        <div className="benefit-grid">
          <article className="benefit-card">
            ...
            <p>Старт — 2 млн ₽ за сеть из 3 постаматов, возможен лизинг оборудования от партнёра.</p>
          </article>
          <article className="benefit-card">
            <span className="icon-badge">
              <TrendingUp size={20} />
