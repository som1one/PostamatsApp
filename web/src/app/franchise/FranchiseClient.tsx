...
const clientSteps = [
  { icon: CreditCard, title: "Оформляет заказ", text: "Выбирает вещь и срок в приложении или на сайте." },
  ...
  { icon: PackageCheck, title: "Получает товар", text: "Открывает ячейку по коду и забирает заказ." },
];
    ...
    <PageChrome>
      ...
      <section className="section-band">
        ...
        <div className="surface detail-panel">
          <p className="muted">
            Похожие автоматические сервисы аренды развиваются в США и Европе — например, проект
            Tulu (tulu.io) ставит постаматы с бытовой техникой, спортивным инвентарём и средствами
            мобильности прямо в местах общего пользования: десятки городов, тысячи домохозяйств и
            сотни тысяч транзакций. Спрос на доступ вместо владения растёт во всём мире, и в России
