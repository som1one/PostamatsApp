...
const USAGE_STEPS: Array<{
  ...
  {
    icon: KeyRound,
    title: "Заберите товар по PIN",
    text: "Введите код в постамате — ячейка откроется. На забор есть 3 часа после оплаты.",
  },
  {
    icon: PackageSearch,
    title: "Верните в любой постамат",
    text: "По окончании срока положите товар обратно. Подтверждение придёт автоматически.",
  },
];
