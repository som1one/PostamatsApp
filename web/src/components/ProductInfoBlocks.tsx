...
const USAGE_STEPS: Array<{
  ...
  },
  {
    ...
    text: "В личном кабинете нажмите «Получить PIN» — код появится на экране. Введите его на клавиатуре постамата, и ячейка откроется. На забор есть 3 часа после оплаты.",
  },
  {
    icon: PackageSearch,
