"""
Добавляет всем активным товарам тарифы 3 / 7 / 14 дней,
рассчитанные от существующего тарифа "1 день".

Коэффициенты: 1/3/7/14 дней => x1 / x2.7 / x5.5 / x10
...
EXTRA_PLANS: list[tuple[str, str, int, Decimal, int]] = [
    ("3 дня", "day", 3, Decimal("2.7"), 1),
    ("7 дней", "day", 7, Decimal("5.5"), 2),
    ("14 дней", "day", 14, Decimal("10"), 3),
]
